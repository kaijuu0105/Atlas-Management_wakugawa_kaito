       ...
       if($startDay <= $day->everyDay() && $toDay >= $day->everyDay()){
        ...
        if($day->everyDay()){
          if($startDay <= $day->everyDay() && $toDay >= $day->everyDay()){
            ...
            $html[] = '<p class="d-flex m-0 p-0">3部<input class="w-25" style="margin-bottom: 10px;height:20px;" name="reserve_day['.$day->everyDay().'][3]" type="text" form="reserveSetting" value="'.$day->threePartFrame($day->everyDay()).'" disabled></p>';
          }else{
            ...
            $html[] = '<p class="d-flex m-0 p-0">3部<input class="w-25" style="margin-bottom: 10px;height:20px;" name="reserve_day['.$day->everyDay().'][3]" type="text" form="reserveSetting" value="'.$day->threePartFrame($day->everyDay()).'"></p>';
          }
        }
        $html[] = '</div>';
        $html[] = '</td>';
